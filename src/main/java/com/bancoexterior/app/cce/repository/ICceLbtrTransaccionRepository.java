...
public interface ICceLbtrTransaccionRepository extends JpaRepository<CceLbtrTransaccion, Integer>{
	...
	public static final String SELECTCCELBTRTRANSACCION ="SELECT referencia, cod_transaccion, canal, monto, "
			+ "moneda, producto, sub_producto, banco_emisor, cuenta_emisor, cuenta_unica_emisor, banco_receptor, cuenta_receptor, cuenta_unica_receptor, iden_emisor, nom_emisor, iden_receptor, nom_receptor, status, fecha_valor, fecha_actualizacion, usuario_creador, usuario_aprobador, id, descripcion "
			+ "FROM cce.lbtr_transacciones where status = 'I' and usuario_creador = ?1";
	
	public static final String SELECTCCELBTRTRANSACCIONCOUNT ="SELECT count(*) as cantidad FROM cce.lbtr_transacciones where status = 'I' and usuario_creador = ?1";
	...
	public Page<CceLbtrTransaccion> consultaLbtrTransacciones(String userName, Pageable pageable);
	
	
	public static final String SELECTCCELBTRTRANSACCIONAPROBARFECHAS ="SELECT referencia, "
			+ "cod_transaccion, canal, monto, moneda, producto, sub_producto, banco_emisor, cuenta_emisor, cuenta_unica_emisor, banco_receptor, cuenta_receptor, cuenta_unica_receptor, iden_emisor, nom_emisor, iden_receptor, nom_receptor, status, fecha_valor, fecha_actualizacion, usuario_creador, usuario_aprobador, id, descripcion "
	...
	@Query(value = SELECTCCELBTRTRANSACCIONAPROBARFECHAS,
		    ...
		    nativeQuery = true)
	public Page<CceLbtrTransaccion> consultaLbtrTransaccionesAprobarFechas(String bancoReceptor, String fechaHoy, Pageable pageable);
