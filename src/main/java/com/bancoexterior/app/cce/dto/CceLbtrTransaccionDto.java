...
public class CceLbtrTransaccionDto {
	...
	@Pattern(regexp = "^[0-9]{20,20}$", message = "Cuenta Ordenante debe ser numerico y contener 20 digitos.")
	...
	@Pattern(regexp = "^[0-9]{20,20}$", message = "Cuenta Bcv Emisor debe ser numerico y contener 20 digitos.")
	...
	@Pattern(regexp = "^[0-9]{20,20}$", message = "Cuenta Beneficiario debe ser numerico y contener 20 digitos.")
